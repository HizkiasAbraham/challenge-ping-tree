...
// define routes and map with controller
...
router.set('/api/target/:id', {
  GET: targetController.getSpecificTarget,
  POST: targetController.updateTarget
})

router.set('/route', { POST: targetController.route })
